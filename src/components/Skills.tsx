...
import { SiHtml5, SiCss3, SiJavascript, SiReact, SiNextdotjs, SiTailwindcss, SiRedux, SiExpress, SiMongodb, SiCplusplus, SiGit, SiGithub,SiVite, SiVercel } from "react-icons/si";
